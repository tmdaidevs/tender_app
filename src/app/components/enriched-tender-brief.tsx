...
export function EnrichedTenderBrief({
  ...
  return (
    <section className="enrichment" aria-labelledby="ai-generated-title">
      <header className="ai-generated-heading">
        <span><Sparkles size={18} /></span>
        <div>
          <small>AI-GENERATED INFORMATION</small>
          <h2 id="ai-generated-title">AI analysis of the official notice</h2>
          <p>
            These sections were generated by OpenAI from the official notice and should
            be verified before making a bid decision.
          </p>
        </div>
      </header>
